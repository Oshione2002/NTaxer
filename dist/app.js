...
function sourcesView(){
 $('#main').innerHTML=`<div class="intro"><p class="eyebrow">Understanding your estimate</p><h1>Sources & methodology</h1><p class="lead">See which sources inform NTaxer, how your estimate is calculated and what to check before using it.</p></div>
