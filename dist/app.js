...
function calcView(id){
 ...
 $('#main').innerHTML=`<div class="intro page-header"><p class="eyebrow">${escape(c.group)} / 2026 tax year</p><div class="heading-row"><h1>${escape(c.name)}</h1><span class="badge ${c.status}">${statusLabel(c.status)}</span></div><p class="lead">${escape(c.description)}</p></div>
